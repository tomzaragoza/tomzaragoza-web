...
export const coursePages: readonly CoursePageDefinition[] = [
  ...
  },
  {
    ...
    content: [
      {
        heading: "1. Ad platforms are basically AI marketing engines",
        paragraphs: [
      ...
      {
        heading: "2. Pixel tracking is non-negotiable",
        paragraphs: [
      ...
      {
        heading: "3. Ads should not look like ads",
        paragraphs: [
      ...
      {
        heading: "4. Show, don't just tell",
        paragraphs: [
      ...
      {
        heading: "5. The campaign is your new feed",
        paragraphs: [
